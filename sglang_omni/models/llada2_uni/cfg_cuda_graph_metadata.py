...
class DllmCFGForwardBatch(ForwardBatch):
    ...
    actual_forward_mode: object | None = None
    num_padding: int = 0
...
def cfg_attention_geometry(batch: ForwardBatch) -> CFGAttentionGeometry:
...
def as_cfg_forward_batch(batch: ForwardBatch) -> DllmCFGForwardBatch:
